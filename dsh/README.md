...
**猎聘为什么不跟着翻**：已实测猎聘风控与有头/无头无关（2026-08-19）——其安全脚本在
页面加载瞬间检测 CDP 会话的 Runtime 域，启用则清页，有头模式 100% 复现；面板不开
Runtime 天然免疫，CLI 侧由 liepin-cli 0.2.4 的 safeGoto 规避。无头不抢焦点是实打实的好处。
